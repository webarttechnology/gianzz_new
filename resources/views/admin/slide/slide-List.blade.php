            ...
            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>{{$title}} List
                            <a href="{{  URL('author/home-slide/add') }}" 
                        ...
                        <table id="customers2" class="table datatable">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td style="color: black;"><?= htmlspecialchars_decode(Str::limit($item -> details,100,$end='...'))	 ?></span></td>
                                    ...
                                    <td style="color: black;"><a
                                            href="{{ URL('/author/home-slide/upate/'.$item -> id) }}"><i
                                                class="fa fa-pencil-square" aria-hidden="true"></i></a> | <a
                                            href="{{ URL('/author/home-slide/delete/'.$item -> id) }}"
