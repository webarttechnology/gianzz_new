							...
							<div class="col-12">
								<div class="card" style="style">
									...
									<span id="errmsg" style="color:red"></span>
										<form class="form-horizontal"  action="{{ url('/author/home-slide/add') }}" method='POST' onsubmit="return valid();" enctype="multipart/form-data" >
                                        @csrf
											<div class="form-group row">
												<label for="inputName" class="col-md-3 col-form-label">Name</label>
												<div class="col-md-9">
													<input type="text" class="form-control" id="title" name="title" placeholder="Silde Name" value="{{ old('title') }}">
													@if ($errors->has('title'))
